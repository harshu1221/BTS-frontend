...
import { User, Mail, Edit, Heart, Sparkles, Calendar } from "lucide-react";
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-8 relative z-10">
                        ...
                        <div className="flex-1 text-center md:text-left w-full">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
                                ...
                                <button 
                                    className="flex items-center gap-2 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white px-6 py-3 rounded-full transition-all shadow-md hover:shadow-lg text-sm font-semibold"
                                >
                            ...
                            <div className="bg-gradient-to-r from-rose-50 to-pink-50 p-5 rounded-xl border-2 border-rose-200">
                                ...
                                <p className="text-gray-700 italic pl-7">
                                    {user.bio || "No bio provided yet. Click 'Edit Profile' to share your story!"}
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                                ...
                                <div className="bg-white border-2 border-rose-200 rounded-xl p-4 text-center">
                                    <div className="text-2xl font-bold text-rose-600">
                                        {myBlogs.reduce((sum, blog) => sum + (blog.likesCount || 0), 0)}
                                    </div>
                                    <div className="text-sm text-gray-600 font-medium">
                                        Total Likes
                                    </div>
                        ...
                        <div className="p-12 text-center bg-white border-2 border-rose-200 rounded-2xl shadow-lg">
                            <div className="max-w-md mx-auto">
                                ...
                                <p className="text-gray-600 mb-6 text-lg">
                                    Start sharing your wedding planning journey with our community! 
                                    Your story could inspire other couples.
                                </p>
                                <button
                                    onClick={() => navigate("/blogs/create")}
